...
Historia::Historia(){
    ...
    Lineal.push_back(new Escena("Una vez en el yermo, la caminata de nuestro aventurero comienza su larga aventura, con las pocas provisiones que logro obtener durante su vida del bunker, nuestro personaje, siguiendose de un mapa roto, que le fue entregado por su madre, sabe que debe viajar a el norte, por lo que avanza con cautela a través de las calles abandonadas y peligrosas de el yermo de lo que alguna  vez fue mérida.", "Imagenes/Escena1.png"));
    ...
    auto o = new Objeto(TipoObjeto::Curar, "Pildora", "Cura 2 puntos al personaje", 2, 2, "Imagenes/Pildora.png");
    aggIn->anadirObjEs(y);
    aggIn->anadirObjEs(o);
    ...
    Lineal.push_back(new Escena(" prueba cap 3","Imagenes/Escena3.png"));
    Lineal.push_back(new Escena(" prueba cap 4", "Imagenes/Escena4.png"));
